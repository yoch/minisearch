...
// Snapshot of the resident index counts documented by fr.gouv.medicaments.rest.
// This profile deliberately keeps the corpus objects, key maps, and all indexes
// reachable while timing searches on the three user-facing BDPM indexes.
const INDEX_SPECS = [
...
function emit(line: string): void {
  ...
  throw new Error('resident engine benchmark: no print() or console.log() available')
}
...
function main(): void {
  ...
  const timings: Record<string, Timing> = { 'resident-build': build }
